...
const incrementNumbers = () => numbers.map((ele) => ele + 3);
...
const getAges = (arr) => arr.map((ele) => ele.age);
...
const getProductNamesInLowerCase = (arr) => arr.map((ele) => ele.name.toLowerCase());
...
const getCityNames = (arr) => arr.map((ele) => ele.name)
...
const filterLongStrings = (arr) => arr.filter((ele) => ele.length > 5)
...
const isDivisibleBy3and5 = arr => arr.filter((ele) => ele % 3 == 0 && ele % 5 == 0)
...
const filterByAge = (arr) => arr.filter((ele) => ele.age > 30)
...
const filterByScore = (arr) => arr.filter((ele) => ele.score > 80)
...
const filterByCityAndAge = (arr) => arr.filter((ele) => ele.city === "Indore" && ele.age > 70)
...
const employee = [
  { name: 'Ridhima', age: 75, salary: 22000 },
  { name: 'Akshay', age: 60, salary: 10000 },
  { name: 'Udit', age: 25, salary: 50000 },
  { name: 'Venki', age: 56, salary: 67000 }
];

const filterEmp = (arr) => arr.filter((ele) => ele.age > 25 && ele.salary > 22000)
